    ...
    <main className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 bg-background">
        <div className="w-full max-w-lg">
          ...
          <h1 className="text-3xl font-bold text-primary font-sora">Iniciar sesión</h1>
          <p className="mt-2 text-slate-600">Ingresá con tu cuenta para continuar.</p>
